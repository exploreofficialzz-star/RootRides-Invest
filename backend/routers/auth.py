...
# Local:  0[7|8|9]XXXXXXXXX  → exactly 11 digits   e.g. 08012345678
# Intl:  +234[7|8|9]XXXXXXXXX → exactly 13 chars   e.g. +2348012345678
...
def validate_and_normalize_phone(raw: str) -> str:
    ...
    if LOCAL_RE.match(phone):
        return "+234" + phone[1:]    # 08012345678 → +2348012345678

    if INTL_RE.match(phone):
    ...
    if not re.match(r"^(0|\+234)[789]", phone):
        raise HTTPException(400, "Network prefix must be 070, 080, or 090 series")
